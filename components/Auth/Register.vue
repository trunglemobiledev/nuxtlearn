        ...
        <v-layout align-center justify-center>
          <v-flex xs12 sm8 md4>
            <v-card class="elevation-12">
              ...
              <v-card-text>
                <v-form>
                  <v-text-field name="firstname" label="Firstname" type="text" v-model="firstName"></v-text-field>
                  <v-text-field name="lastname" label="Lastname" type="text" v-model="lastName"></v-text-field>
